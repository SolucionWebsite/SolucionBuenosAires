<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Comprobante.aspx.cs" Inherits="BuenosAiresWeb.GUI.Comprobante" %>
        ...
        <div class="container" style="border:1px solid gainsboro">
            ...
            <asp:GridView ID="GrdProductos" runat="server" class="table table-bordered" style="margin-top:20px;">
             ...
             <br />
                ...
                <br />
                <h6>PUEDES REALIZAR EL SEGUIMIENTO DE TU COMPRA CON EL N° DE ORDEN DE COMPRA <a href="/Seguimiento">AQUÍ</a></h6>
        </div>
